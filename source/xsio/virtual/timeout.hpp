...
namespace XSIO::Virtual {
    ...
    class Timeout {
        ...
        class Action : public Timer::Action::Abstract<Action> {
            //  PROPERTIES  //
           ...
           public:
            ...
            inline void execute(Virtual::Thread* thread, Virtual::Processor* processor) const final {
                m_self->m_callback(thread, processor);
            }
        };
        ...
        class Worker : public Task::Abstract<Worker> {
           ...
           protected:
            ...
            inline void m_execute() final {
                ...
                auto action = $::New().unique<Action>(m_self);
        ...
        Timer::Callback m_callback = [](Thread*, Processor*) {};
