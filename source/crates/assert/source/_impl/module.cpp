...
static Talos::Value::Any g_failed = Talos::String::Small("Failed");
...
TALOS_MM_DYLIB_METHOD(Assert, test, isolate, args, bool state, const $::String::View &method) {
...
Talos::Value::Any Talos::Package::Assert::m_panic(Runtime::Isolate *isolate, Object::Exception exception) {
