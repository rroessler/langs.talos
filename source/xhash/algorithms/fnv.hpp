...
template <std::integral T, T P, T S> class Digest {
  //  PROPERTIES  //
...
public:
  ...
  inline constexpr T operator()(const std::string_view &view, T value = m_seed) const noexcept {
  ...
  template <class... As> inline constexpr T digest(As &&...args) const noexcept {
...
static inline constexpr auto U32 = Digest<uint32_t, 0x1000193, 0x811c9dc5>();
static inline constexpr auto U64 = Digest<uint64_t, 0x100000001b3, 0xcbf29ce484222325>();
