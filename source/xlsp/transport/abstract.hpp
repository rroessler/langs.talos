...
struct $_ABSTRACT Abstract {
   ...
   */
  virtual int32_t listen(Event::Emitter *events) = 0;
   ...
   */
  virtual void request(const Request::Identifier &id, const Message::Method &method, const Message::Params &params) = 0;
