#ifndef _XPC_CORE_IDENTIFIER_HPP
#define _XPC_CORE_IDENTIFIER_HPP

/// XPC Modules
#include "xpc/forward/core.hpp"
...
namespace XPC::Core {
    ...
    class Identifier : public $::Printable {
       ...
       protected:
         ...
         */
        static inline void m_print($::Stream::Output& os, const Identifier& self) { os << self.m_pid; }
    };
