...
$_NORETURN void Forge::Runtime::Main::m_execute() {
...
void Forge::Runtime::Main::m_analyze(const $::URI::Buffer& resource) {
...
Forge::Value::Any Forge::Runtime::Main::m_import(const $::String::View& script) {
