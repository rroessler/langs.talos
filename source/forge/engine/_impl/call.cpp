...
Forge::Value::Any Forge::Engine::Call::any(Isolate* isolate, Value::Any target, const Arguments& args) {
...
Forge::Value::Any Forge::Engine::Call::native(Isolate* isolate, Function::Native native, const Arguments& args) {
...
Forge::Value::Any Forge::Engine::Call::closure(Isolate* isolate, Function::Closure closure, const Arguments& args) {
    return m_closure(isolate, closure.info(), closure.context(), args);
}

Forge::Value::Any Forge::Engine::Call::inlined(Isolate* isolate, Function::Frame* frame, const Arguments& args) {
    return m_closure(isolate, frame->info(), frame->context(), args);
}

Forge::Value::Any Forge::Engine::Call::jitted(Isolate* isolate, Function::Jitted jitted, const Arguments& args) {
    return m_jitted(isolate, jitted.info(), jitted.context(), args);
}

Forge::Value::Any Forge::Engine::Call::inlined(Isolate* isolate, const Machine::Info* info, const Arguments& args) {
...
bool Forge::Engine::Call::m_validate(Isolate* isolate, Function::Dynamic target, const Arguments& args) {
    return m_validate(isolate, target.arity(), args);
}

bool Forge::Engine::Call::m_validate(Isolate* isolate, const Function::Info* info, const Arguments& args) {
    return m_validate(isolate, info->arity(), args);
}

bool Forge::Engine::Call::m_validate(Isolate* isolate, size_t arity, const Arguments& args) {
...
Forge::Function::Context Forge::Engine::Call::m_initialize(
...
Forge::Value::Any Forge::Engine::Call::m_closure(
...
Forge::Value::Any Forge::Engine::Call::m_jitted(
