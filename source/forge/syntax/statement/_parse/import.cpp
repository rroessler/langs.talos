...
Forge::Syntax::Node* Forge::Parser::Dispatch::m_import(Stream* parser, bool module) {
...
Forge::Syntax::Node* Forge::Parser::Dispatch::m_export(Stream* parser, bool module) {
...
FORGE_MM_PARSE_STMT(Import, parser) {
