...
FORGE_MM_FORMAT_STMT(Break, reader) { return reader->storage()->unicode(reader->advance()->lexeme()); }
FORGE_MM_FORMAT_STMT(Continue, reader) { return reader->storage()->unicode(reader->advance()->lexeme()); }
FORGE_MM_FORMAT_STMT(Return, reader) {
