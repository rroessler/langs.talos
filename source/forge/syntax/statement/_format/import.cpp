...
Forge::Format::Node* Forge::Format::Dispatch::m_import(Reader* reader, bool exported) {
...
Forge::Format::Node* Forge::Format::Dispatch::m_export(Reader* reader) {
...
FORGE_MM_FORMAT_STMT(Import, reader) { return m_import(reader, false); }
