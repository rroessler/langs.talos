...
Forge::Syntax::Variable* Forge::Parser::Dispatch::m_variable(Stream* parser, bool annotated) {
    ...
    auto* variable = parser->allocate<Syntax::Variable>(name->lexeme(), hint, initializer, snapshot.enclose(name));
...
FORGE_MM_PARSE_DECL(Variable, parser) { return m_variable(parser, false); }
