...
$_FWD(Entity target(Analyzer *, const Syntax::Expression *), Forge::Type::Dispatch)
$_FWD(Deduction immutable(Analyzer *, const Syntax::Expression *), Forge::Type::Dispatch)

//  PUBLIC METHODS  //

Forge::Type::Entity Forge::Type::Dispatch::target(Analyzer *analyzer, const Syntax::Expression *target) {
...
Forge::Type::Deduction Forge::Type::Dispatch::immutable(Analyzer *analyzer, const Syntax::Expression *target) {
...
FORGE_MM_CHECK_NODE(Assign, node, analyzer) {
