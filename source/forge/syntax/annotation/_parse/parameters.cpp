...
Forge::Syntax::Parameters* Forge::Parser::Dispatch::m_parameters(Stream* parser, bool annotated) {
...
FORGE_MM_PARSE_HINT(Parameters, parser) { return m_parameters(parser, true); }
FORGE_MM_PARSE_DECL(Parameters, parser) { return m_parameters(parser, false); }
