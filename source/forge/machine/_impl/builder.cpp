...
$_FWD(void cancel(Runtime::Isolate*), Forge::Machine::Dispatch)

//  CONSTRUCTORS  //

Forge::Machine::Builder::Builder(Info* info, Compiler* compiler) :
...
void Forge::Machine::Dispatch::cancel(Runtime::Isolate* isolate) { isolate->panic(9000200); }
