#ifndef _FORGE_MACHINE_EMITTER_HPP
#define _FORGE_MACHINE_EMITTER_HPP
...
$_FWD(static inline constexpr bool FAST = true, Forge::Machine::Validate)
$_FWD(static inline constexpr bool SLOW = false, Forge::Machine::Validate)
