#ifndef _FORGE_RESOURCE_TRACE_HPP
#define _FORGE_RESOURCE_TRACE_HPP
...
namespace Forge::Resource {
    ...
    class Trace : public $::Printable {
       ...
       public:
        ...
        /// @brief Constructs a defaulted trace value.
        constexpr Trace() : Trace($::URI::Anonymous()) {}
        ...
        inline constexpr bool anonymous() const noexcept {
            return m_position == nullptr && m_resource == $::URI::Anonymous();
        }
...
#undef X
         ...
         */
        static inline void m_print($::Stream::Output& os, const Trace& self) {
            // show the incoming resource instance now
            os << self.m_describe() << " at ";
            os << self.resource().relative();
