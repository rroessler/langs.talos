#ifndef _FORGE_TYPE_BUILDER_HPP
#define _FORGE_TYPE_BUILDER_HPP
...
#include "forge/type/compound/instance.hpp"
#include "forge/type/compound/protocol.hpp"
#include "forge/type/compound/prototype.hpp"
#include "forge/type/resolver/asyncify.hpp"
#include "forge/type/resolver/awaited.hpp"
#include "forge/type/resolver/invoker.hpp"
#include "forge/type/resolver/iterable.hpp"
#include "forge/type/utility/generic.hpp"
#include "forge/type/utility/intrinsics.hpp"
#include "forge/type/utility/parameter.hpp"
#include "forge/type/utility/transform.hpp"
#include "forge/type/utility/union.hpp"

//  X-MACROS  //

#define FORGE_XX_TYPES_LIST(X) \
    X(Any, any)                \
    X(None, none)              \
    X(Maybe, maybe)            \
    X(Never, never)            \
...
#undef X
    ...
    inline constexpr $::Ptr::Shared<Prototype> resolve(const Erased& type) {
        ...
        return type->is<Instance>() ? type->as<Instance>()->prototype() : nullptr;
    }
    ...
    inline constexpr $::Ptr::Shared<Callable> resolve(const Erased& type) {
        ...
        if (type->is<Prototype>()) return resolve<Callable>(type->as<Prototype>()->constructor());
        return type->is<Callable>() ? type->as<Callable>() : nullptr;  // valid lookup here
    }
