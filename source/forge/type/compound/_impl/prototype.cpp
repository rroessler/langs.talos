...
$::Ptr::Shared<Forge::Type::Instance> Forge::Type::Prototype::instantiate() {
...
Forge::Type::Erased Forge::Type::Prototype::m_infer(const Constraints& constraints) const {
    ...
    if (m_constructor) inferred->m_constructor = m_constructor->infer(constraints);
...
bool Forge::Type::Prototype::m_unify(const Erased& candidate, const Constraints& constraints) const {
...
void Forge::Type::Prototype::m_print($::Stream::Output& os) const { os << "class " << name(); }
