...
Forge::Type::Erased Forge::Type::Protocol::m_infer(const Constraints& constraints) const {
...
bool Forge::Type::Protocol::m_unify(const Erased& candidate, const Constraints& constraints) const {
...
void Forge::Type::Protocol::m_print($::Stream::Output& os) const {
