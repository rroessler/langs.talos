...
Forge::Type::Erased Forge::Type::Union::m_infer(const Constraints& constraints) const {
...
bool Forge::Type::Union::m_unify(const Erased& candidate, const Constraints& constraints) const {
