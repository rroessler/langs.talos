...
Forge::Type::Erased Forge::Type::Generic::instantiate(std::vector<Erased> arguments) const {
...
Forge::Type::Erased Forge::Type::Generic::m_infer(const Constraints& constraints) const {
    return Builder::generic(m_target->infer(constraints), m_parameters);
}

bool Forge::Type::Generic::m_unify(const Erased& candidate, const Constraints& constraints) const {
...
void Forge::Type::Generic::m_print($::Stream::Output& os) const {
