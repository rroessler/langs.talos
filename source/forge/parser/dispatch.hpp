#ifndef _FORGE_PARSER_DISPATCH_HPP
#define _FORGE_PARSER_DISPATCH_HPP
...
#define FORGE_MM_PARSE_FWD(N, R, T, ...) \
    template <>                          \
    Forge::Syntax::R* Forge::Parser::Dispatch::m_##N<Forge::Syntax::T>(__VA_ARGS__)

#define FORGE_MM_PARSE_DECL(T, P, ...) FORGE_MM_PARSE_FWD(declaration, T, T, Stream* P)
#define FORGE_MM_PARSE_STMT(T, P, ...) FORGE_MM_PARSE_FWD(statement, T, T, Stream* P)
#define FORGE_MM_PARSE_HINT(T, P, ...) FORGE_MM_PARSE_FWD(annotation, T, T, Stream* P)
#define FORGE_MM_PARSE_PREFIX(T, P, A, ...) FORGE_MM_PARSE_FWD(prefix, Expression, T, Stream* P, bool A)
#define FORGE_MM_PARSE_INFIX(T, P, E, A, ...) \
    FORGE_MM_PARSE_FWD(infix, Expression, T, Stream* P, Syntax::Expression* E, bool A)
