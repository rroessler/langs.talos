...
Forge::Import::Service::Service() : Service($::Global::get<Runtime::Container>()) {}
Forge::Import::Service::Service(XI::Container* services) : m_services(services) {
#define X(N, ...)                                         \
...
Forge::Import::Statistics Forge::Import::Service::analyze(const $::URI::View& resource, bool report) {
    return analyze(resource.buffer(), report);
}

Forge::Import::Statistics Forge::Import::Service::analyze(
    const $::URI::View& resource, Diagnostic::Reporter* reporter, bool display) {
    return analyze(resource.buffer(), reporter, display);
}

Forge::Import::Statistics Forge::Import::Service::analyze(const $::URI::Buffer& resource, bool report) {
...
Forge::Import::Statistics Forge::Import::Service::analyze(const Dependencies& dependencies, bool report) {
...
Forge::Module::Interface* Forge::Import::Service::fetch(const $::URI::View& resource) {
...
void Forge::Import::Service::preload(std::vector<$::Ptr::Unique<Linker::Arena>>&& arenas) {
    for (auto&& arena : arenas) m_drafts->emplace($::New().unique<Module::Archived>(std::move(arena)));
}

Forge::Async::Thenable* Forge::Import::Service::import(Runtime::Isolate* isolate, const $::URI::View& resource) {
    return import(isolate, resource, {});
}

Forge::Async::Thenable* Forge::Import::Service::import(
...
Forge::Resource::Result Forge::Import::Service::resolve(
...
Forge::Module::Interface* Forge::Import::Service::m_prepare(Module::Interface* module) const {
