...
Forge::Heap::Service::Service() : Service($::Global::get<Runtime::Container>()) {}
Forge::Heap::Service::Service(XI::Container* services) :
...
Forge::Heap::Service::~Service() { $::Memory::Map::free(m_data, Limits::ADDRESS_SPACE), m_data = nullptr; }

//  PUBLIC METHODS  //

size_t Forge::Heap::Service::usage() const noexcept {
...
void Forge::Heap::Service::shrink() {
...
Forge::Heap::Region* Forge::Heap::Service::release(Region* region) {
...
Forge::Heap::Region* Forge::Heap::Service::acquire(Stage stage, Region* parent) {
...
void Forge::Heap::Service::m_unmap() {
