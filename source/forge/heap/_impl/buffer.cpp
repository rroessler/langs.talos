...
Forge::Heap::Buffer::Buffer(Stage stage) : Buffer($::Global::get<Runtime::Container>()->get<Heap::Service>(), stage) {}
Forge::Heap::Buffer::Buffer(Heap::Service* heap, Stage stage) : m_stage(stage), m_heap(heap) {}

//  PRIVATE METHODS  //

void Forge::Heap::Buffer::m_release(Address address, size_t size) {
...
Forge::Heap::Address Forge::Heap::Buffer::m_allocate(Runtime::Isolate* isolate, size_t size) {
...
void Forge::Heap::Buffer::m_acquire() {
