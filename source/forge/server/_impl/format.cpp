...
void Forge::Server::Events::on_document_format(XLSP_REQUEST(DOCUMENT_FORMAT) request) {
...
std::vector<XLSP::Document::Edit> Forge::Server::Worker::format() const noexcept { return format(m_crate->format()); }
std::vector<XLSP::Document::Edit> Forge::Server::Worker::format(const Format::Options& options) const noexcept {
