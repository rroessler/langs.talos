...
$_FWD(XLSP::Encoding::Type query(const $::Serde::Value &), Forge::Server::Encoding)
 ...
 */
XLSP::Encoding::Type Forge::Server::Encoding::query(const $::Serde::Value &capabilities) {
...
void Forge::Server::Events::on_initialize(XLSP_REQUEST(LIFECYCLE_INITIALIZE) request) {
...
void Forge::Server::Events::on_shutdown(XLSP_REQUEST(LIFECYCLE_SHUTDOWN, XLSP::Event::Answer) request) {
