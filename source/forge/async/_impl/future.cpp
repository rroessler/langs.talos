...
Forge::Object::Attributes<Forge::Async::Future>::Attributes(Runtime::Isolate* callee, Function::Dynamic callback) :
    Attributes(callee, callback, {}) {}

Forge::Object::Attributes<Forge::Async::Future>::Attributes(
...
Forge::Async::Result Forge::Async::Future::timeout(Thread* thread, const $::Chrono::Duration& duration) const noexcept {
...
Forge::Value::Any Forge::Async::Future::timeout(
...
Forge::Async::Result Forge::Async::Future::await(Thread* thread) const noexcept { return thenable()->await(thread); }
Forge::Value::Any Forge::Async::Future::await(Runtime::Isolate* isolate) const noexcept {
    return thenable()->await(isolate);
}

//  PRIVATE METHODS  //

void Forge::Object::Attributes<Forge::Async::Future>::m_initialize(Runtime::Isolate* isolate) {
...
void Forge::Async::Future::m_yield(const Future& self, const Globals::Each& yield) {
...
Forge::Async::Timeout Forge::Async::Future::m_timeout(const $::Chrono::Duration& duration) const noexcept {
