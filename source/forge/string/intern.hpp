#ifndef _FORGE_STRING_INTERN_HPP
#define _FORGE_STRING_INTERN_HPP

/// Forge Modules
#include "forge/string/runes.hpp"
#include "forge/value/symbol.hpp"

namespace Forge::String {

    /// @brief String Intern Attributes.
    class Intern : public $::Printable {
        //  TYPEDEFS  //
       ...
       public:
         ...
         */
        constexpr Intern(const $::String::View& buffer, Value::Symbol symbol) : m_runes(buffer), m_symbol(symbol) {
       ...
       protected:
         ...
         */
        static inline void m_print($::Stream::Output& os, const Intern& self) { os << self.m_runes; }
    };
