#ifndef _FORGE_GLOBALS_SERVICE_HPP
#define _FORGE_GLOBALS_SERVICE_HPP
...
#define FORGE_MM_GLOBALS_NATIVE(I, N, C, ...)                                     \
    I->service<::Forge::Globals::Service>()->internal<::Forge::Function::Native>( \
        I, N, [](::Forge::Runtime::Isolate* isolate) { return isolate->create<::Forge::Function::Native>(C, N); })

//  NAMESPACES  //

namespace Forge::Globals {
