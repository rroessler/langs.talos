...
Forge::Format::Node* Forge::Format::Dispatch::m_attribute(Reader*) { return nullptr; }
Forge::Format::Node* Forge::Format::Dispatch::m_decorator(Reader*) { return nullptr; }

Forge::Format::Node* Forge::Format::Dispatch::m_preamble(Reader* reader) {
