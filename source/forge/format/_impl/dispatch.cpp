...
Forge::Format::Node::List* Forge::Format::Dispatch::m_collection(Reader* reader, Delimited&& delimited) {
...
Forge::Format::Node::List* Forge::Format::Dispatch::m_delimited(Reader* reader, Delimited&& delimited) {
...
Forge::Format::Node* Forge::Format::Dispatch::m_terminates(Reader* reader, Node* node) {
