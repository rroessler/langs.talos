...
Forge::Format::Node* Forge::Format::Dispatch::m_declaration(Reader* reader) {
...
Forge::Format::Node* Forge::Format::Dispatch::m_subject(Reader* reader) {
    return m_subject(reader, reader->peek(INT32_MAX)->kind());
}

Forge::Format::Node* Forge::Format::Dispatch::m_subject(Reader* reader, Lexer::Kind kind) {
    switch (kind) {
        case Lexer::Kind::DECL_LET: $_FALLTHROUGH;
        case Lexer::Kind::DECL_USE: $_FALLTHROUGH;
...
Forge::Format::Node* Forge::Format::Dispatch::m_modifiers(Reader* reader, Variable::Modifiers modifiers) {
