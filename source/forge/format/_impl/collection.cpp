...
bool Forge::Format::Collection::append(Node* item, Node* trailing) noexcept {
...
void Forge::Format::Collection::whitespace(Node* node) noexcept {
    m_leading.try_emplace(m_buffer.size(), Buffer()).first->second.emplace_back(node);
}

Forge::Format::Node::List* Forge::Format::Collection::merge(Storage* storage, bool trailing) const noexcept {
...
Forge::Format::Collection::Whitespace Forge::Format::Collection::m_trim(Whitespace whitespace) const noexcept {
...
Forge::Format::Node* Forge::Format::Collection::m_flush(Storage* storage, size_t index, bool trailing) const noexcept {
...
Forge::Format::Node* Forge::Format::Collection::m_suffix(Storage* storage, size_t index, bool trailing) const noexcept {
