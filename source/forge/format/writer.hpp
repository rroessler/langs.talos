#ifndef _FORGE_FORMAT_WRITER_HPP
#define _FORGE_FORMAT_WRITER_HPP
...
namespace Forge::Format {
    ...
    class Writer {
       ...
       public:
         ...
         */
        template <class... As>
        inline constexpr void concat(const $::String::View& value, As&&... args) noexcept {
         ...
         */
        inline constexpr bool exceeds(const Node* node, bool force = false) const noexcept {
            return exceeds(node->width(m_wrapped, force));
        }
