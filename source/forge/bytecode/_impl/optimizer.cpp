...
Forge::Bytecode::Optimizer::Optimizer(Binder *labels) : Optimizer($::Global::get<Runtime::Container>(), labels) {}

Forge::Bytecode::Optimizer::Optimizer(XI::Container *services, Binder *labels) :
    Optimizer(labels, services->get<Runtime::Options>()) {}

Forge::Bytecode::Optimizer::Optimizer(Binder *labels, const Runtime::Options *options) :
    m_labels(labels), m_options(options) {}

//  PUBLIC METHODS  //

void Forge::Bytecode::Optimizer::process(Routine *routine) const {
...
void Forge::Bytecode::Optimizer::m_build_graph(Routine *routine) const {
...
void Forge::Bytecode::Optimizer::m_dump_graph(Routine *routine) const {
...
void Forge::Bytecode::Optimizer::m_remove_dead_ir(Routine *routine) const {
...
void Forge::Bytecode::Optimizer::m_remove_empty_blocks(Routine *routine) const {
...
void Forge::Bytecode::Optimizer::m_rewrite_chained_branches(Routine *routine) const {
...
void Forge::Bytecode::Optimizer::m_remove_dead_blocks(Routine *routine) const {
...
void Forge::Bytecode::Optimizer::m_remove_useless_jumps(Routine *routine) const {
