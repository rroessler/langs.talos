...
Forge::Bytecode::Assembler::Assembler() : Assembler($::Global::get<Runtime::Container>()) {}
Forge::Bytecode::Assembler::Assembler(XI::Container* services) : Assembler(services->get<Runtime::Options>()) {}
Forge::Bytecode::Assembler::Assembler(const Runtime::Options* options) : m_options(options) {}

//  PUBLIC METHODS  //

Forge::Linker::View Forge::Bytecode::Assembler::process(Routine* routine, Linker::Arena* arena) {
...
void Forge::Bytecode::Assembler::m_patch(Linker::Buffer& buffer, Linker::Arena* arena) const {
...
uint64_t Forge::Bytecode::Assembler::m_encode(const Instruction* instruction, Label::Encoded offset) {
...
int32_t Forge::Bytecode::Assembler::m_elide(Cache& instructions, const Instruction* current) const {
