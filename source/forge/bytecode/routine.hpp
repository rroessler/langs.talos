#ifndef _FORGE_BYTECODE_ROUTINE_HPP
#define _FORGE_BYTECODE_ROUTINE_HPP
...
#include "forge/string/intern.hpp"
...
namespace Forge::Bytecode {
    ...
    struct Routine {
        ...
        std::vector<$::Ptr::Unique<Block>> blocks = {};

        //  CONSTRUCTORS  //

        /// @brief Do not allow default construction.
        explicit Routine() = delete;

        /**
         * @brief Constructs a routine instance.
         * @param shared                  Shared bytecode information.
         */
        explicit Routine(Shared* shared) : shared(shared) {}
    };
