...
FORGE_BUILTIN_STORAGE(String::Dynamic) = Forge::Member::Storage(name(), { FORGE_XX_FIELDS_STRING(X) });
#undef X

//  PUBLIC METHODS  //

FORGE_MM_BUILTIN_FIELD(String::Dynamic, hash, isolate, args) {
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
    return args.self<String::Dynamic>().symbol();  // get symbol
}

FORGE_MM_BUILTIN_FIELD(String::Dynamic, size, isolate, args) {
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
    return Number::Tagged(args.self<String::Dynamic>().size());
}

FORGE_MM_BUILTIN_FIELD(String::Dynamic, bytes, isolate, args) {
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
    return Number::Tagged(args.self<String::Dynamic>().bytes());
}

FORGE_MM_BUILTIN_FIELD(String::Dynamic, empty, isolate, args) {
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
    return Number::Tagged(args.self<String::Dynamic>().size() == 0);
}

FORGE_MM_BUILTIN_FIELD(String::Dynamic, at, isolate, args) {
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, slice, isolate, args) {
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, compare, isolate, args) {
    // prepare the underlying assertions
    FORGE_MM_ASSERT_ARGC(isolate, args.size(), 1);
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, contains, isolate, args) {
    // prepare the underlying assertions
    FORGE_MM_ASSERT_ARGC(isolate, args.size(), 1);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args[0]);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, starts_with, isolate, args) {
    // prepare the underlying assertions
    FORGE_MM_ASSERT_ARGC(isolate, args.size(), 1);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args[0]);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, ends_with, isolate, args) {
    // prepare the underlying assertions
    FORGE_MM_ASSERT_ARGC(isolate, args.size(), 1);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args[0]);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, to_upper, isolate, args) {
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, to_lower, isolate, args) {
    // ensure some incoming conditions now
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, trim_both, isolate, args) {
    // ensure some incoming conditions now
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, trim_leading, isolate, args) {
    // ensure some incoming conditions now
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, trim_trailing, isolate, args) {
    // ensure some incoming conditions now
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, pad_leading, isolate, args) {
    // ensure some incoming conditions now
    FORGE_MM_ASSERT_ARGC(isolate, args.size(), 1);
    FORGE_MM_ASSERT_TYPEOF(isolate, Number::Tagged, args[0]);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, pad_trailing, isolate, args) {
    // ensure some incoming conditions now
    FORGE_MM_ASSERT_ARGC(isolate, args.size(), 1);
    FORGE_MM_ASSERT_TYPEOF(isolate, Number::Tagged, args[0]);
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, args.self());
...
FORGE_MM_BUILTIN_FIELD(String::Dynamic, fmt, isolate, args) {
    // get the self instance to be used
    auto self = args.self();

    // ensure we validate the incoming details
    FORGE_MM_ASSERT_TYPEOF(isolate, String::Dynamic, self);
...
Forge::Member::View FORGE_BUILTIN_TRAITS(String::Dynamic)::m_attributes(const String::Dynamic&, Value::Symbol symbol) {
