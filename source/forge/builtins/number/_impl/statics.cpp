...
FORGE_MM_BUILTIN_STATIC(Number::Tagged, parse, isolate, args) {
    ...
    try {
        ...
        FORGE_MM_ASSERT_TYPEOF(isolate, Number::Tagged, radix);
...
Forge::Value::Any FORGE_BUILTIN_TRAITS(Number::Tagged)::m_globals(Runtime::Isolate* isolate) {
