...
FORGE_MM_BUILTIN_STATIC(Iterable::List, from, isolate, args) {
...
FORGE_MM_BUILTIN_STATIC(Iterable::List, empty, isolate, ) { return isolate->create<Iterable::List>(); }

FORGE_MM_BUILTIN_STATIC(Iterable::List, range, isolate, args) {
    ...
    FORGE_MM_ASSERT_TYPEOF(isolate, Number::Tagged, start);
    FORGE_MM_ASSERT_TYPEOF(isolate, Number::Tagged, end);
    FORGE_MM_ASSERT_TYPEOF(isolate, Number::Tagged, step);
...
FORGE_MM_BUILTIN_STATIC(Iterable::List, filled, isolate, args) {
    // ensure we have an incoming value
    ...
    FORGE_MM_ASSERT_LOWER(isolate, size, 0);
    FORGE_MM_ASSERT_INTEGRAL(isolate, size);
...
Forge::Value::Any FORGE_BUILTIN_TRAITS(Iterable::List)::m_globals(Runtime::Isolate* isolate) {
