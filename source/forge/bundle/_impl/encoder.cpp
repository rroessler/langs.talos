...
void Forge::Bundle::Encoder::m_encode(const Filesystem& fs, Sink& sink) const noexcept {
...
void Forge::Bundle::Encoder::m_encode(const Linker::Arena& arena, Sink& sink) const noexcept {
...
void Forge::Bundle::Encoder::m_encode(const $::URI::View& resource, Sink& sink) const noexcept {
    m_write($::URI::Buffer("arch", resource.relative()).view(), sink);
}

void Forge::Bundle::Encoder::m_encode(const Function::Info& info, Sink& sink) const noexcept {
...
void Forge::Bundle::Encoder::m_encode(const Value::Any& value, Sink& sink) const noexcept {
