...
namespace XJCT::Archive {
    ...
    struct Provider {
         ...
         */
        inline constexpr bool codesign(const $::Filesystem::Path& binary) const noexcept {
         ...
         */
        inline constexpr Blob resource(const $::String::View& name) const noexcept {
            auto* target = m_resolve();  // resolve target
         ...
         */
        inline constexpr Blob resource(const Sentinel::View& fuse) const noexcept {
