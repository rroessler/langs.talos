...
static auto g_target_linux = $::New().unique<XJCT::Target::Linux>();
static auto g_target_darwin = $::New().unique<XJCT::Target::Darwin>();
static auto g_target_windows = $::New().unique<XJCT::Target::Windows>();
