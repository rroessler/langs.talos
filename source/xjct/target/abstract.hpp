...
namespace XJCT::Target {
    ...
    struct $_ABSTRACT Abstract {
         ...
         */
        inline Archive::Blob resource(const $::String::View& name) const noexcept { return m_resource(name); }

        /**
         * @brief Handles codesigning a file.
         * @param binary            Binary file-path.
         */
        inline bool codesign(const $::Filesystem::Path& binary) const noexcept { return m_codesign(binary); }
       ...
       protected:
         ...
         * @param binary            Binary file-path.
         */
        virtual bool m_codesign(const $::Filesystem::Path&) const noexcept { return true; }

        /**
         * @brief Gets a resource from a target.
         * @param name              Name of resource.
         */
        virtual Archive::Blob m_resource(const $::String::View&) const noexcept { return ""; }
