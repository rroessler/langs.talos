...
namespace XT::Assert {
    ...
    class That {
        ...
        friend class Reporter::Interface;
       ...
       public:
         ...
         */
        inline constexpr Info info(const $::String::View& message, const Location& location) {
         ...
         * @param location              Assertion location.
         */
        inline constexpr Info info(
            const $::String::View& label, const $::String::View& message, const Location& location) {
         ...
         * @param location              Assertion location.
         */
        inline bool fail(const $::String::View& because = "", const Location& location = $::Location()) {
        ...
        inline bool okay(T value, const $::String::View& because = "", const Location& location = $::Location()) {
        ...
        inline bool equal(
            T actual, U expected, const $::String::View& because = "", const Location& location = $::Location()) {
