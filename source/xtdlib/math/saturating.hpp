...
template <std::integral T> static inline constexpr T saturating_add(T x, T y) {
...
template <std::integral T> static inline constexpr T saturating_sub(T x, T y) {
...
template <std::integral T> static inline constexpr T saturating_mul(T x, T y) {
...
template <std::integral T> static inline constexpr T saturating_div(T x, T y) {
