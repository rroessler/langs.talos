...
template <std::integral T> static inline constexpr T add_sat(T x, T y) {
...
template <std::integral T> static inline constexpr T sub_sat(T x, T y) {
...
template <std::integral T> static inline constexpr T mul_sat(T x, T y) {
...
template <std::integral T> static inline constexpr T div_sat(T x, T y) {
