...
namespace $::URI {
    ...
    /// @brief Core URI buffer of the form "<scheme>:[//<authority>]<body>".
    class View : public Printable {
       ...
       public:
        ...
        inline constexpr Buffer buffer() const { return Buffer(*m_buffer); }
        ...
        inline constexpr String::View scheme() const { return m_buffer->scheme(); }

        /// @brief Gets the entire body value.
        inline constexpr String::View body() const { return m_buffer->body(); }

        /// @brief Gets the underlying authority value.
        inline constexpr String::View authority() const { return m_buffer->authority(); }
       ...
       protected:
         ...
         */
        static inline void m_print(Stream::Output& os, const View& self) { os << *self.m_buffer; }
    };
...
template <>
struct ankerl::unordered_dense::hash<$::URI::Buffer> {
...
template <>
struct ankerl::unordered_dense::hash<$::URI::View> {
    using is_avalanching = void;  // declare that this is not avalanchable
