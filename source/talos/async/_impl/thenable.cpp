...
bool Talos::Async::Thenable::resolve(Runtime::Isolate* isolate, Value::Any value) noexcept {
    return Deferred::resolve(isolate->thread(), value);
}

bool Talos::Async::Thenable::reject(Runtime::Isolate* isolate, Value::Any exception) noexcept {
