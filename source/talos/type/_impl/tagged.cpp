...
Talos::Type::Entity Talos::Type::Tagged::lookup(const $::String::View&) const { return Entity(); }

Talos::Type::Erased Talos::Type::Tagged::apply(Operator::Kind kind) const {
    switch (kind) {
...
Talos::Type::Erased Talos::Type::Tagged::apply(Operator::Kind kind, const Erased& right) const {
    switch (kind) {
...
bool Talos::Type::Tagged::unify(const Erased& candidate, const Constraints& constraints) const {
...
bool Talos::Type::Tagged::m_unify(const $::Ptr::Shared<Generic>& generic, const Constraints& constraints) const {
...
bool Talos::Type::Tagged::m_unify(const $::Ptr::Shared<Parameter>& parameter, const Constraints& constraints) const {
...
void Talos::Type::Tagged::m_print($::Stream::Output& os, const Tagged& self) { self.m_print(os); }
