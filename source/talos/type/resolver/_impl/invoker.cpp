...
Talos::Type::Erased Talos::Type::Utility::Invoker::operator()(
 ...
 */
Talos::Type::Erased Talos::Type::Utility::Invoker::m_returns(const $::Ptr::Shared<Callable>& callable) const noexcept {
