...
namespace Talos::Type {
    ...
    class World {
       ...
       public:
         ...
         */
        inline constexpr bool declare(const $::String::View& name, const Entity& entity) {
            return declare(name, entity, {});
        }
         ...
         */
        inline constexpr bool declare(const $::String::View& name, const Resource::Location& location = {}) {
            return declare(name, {}, location);
        }
         ...
         * @param location                      Location value.
         */
        inline constexpr bool declare(
            const $::String::View& name, const Entity& entity, const Resource::Location& location) {
