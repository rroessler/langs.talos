...
Talos::Bundle::Filesystem Talos::Bundle::Decoder::m_decode(Source source) const noexcept {
...
void Talos::Bundle::Decoder::m_decode($::Ptr::Unique<Linker::Arena>& arena, Source& source) const noexcept {
...
void Talos::Bundle::Decoder::m_decode($::Ptr::Unique<Function::Info>& info, Source& source) const noexcept {
