#ifndef _TALOS_SYNTAX_GENERATOR_HPP
#define _TALOS_SYNTAX_GENERATOR_HPP
...
#define TALOS_XX_TOKEN_UNARY(N, ...) s_table[_(K::UNOP_##N)] = R(D::template m_prefix<Unary>);
#include "talos/lexer/_defines/tokens.def"

#define TALOS_XX_TOKEN_BINARY(N, S, P, ...) s_table[_(K::BINOP_##N)] = R(D::template m_infix<Binary>, Precedence::P);
#include "talos/lexer/_defines/tokens.def"
