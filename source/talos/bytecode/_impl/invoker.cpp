...
void Talos::Bytecode::Invoker::invoke(
...
void Talos::Bytecode::Invoker::spawn(
    Compiler* compiler, Destination destination, const std::vector<Syntax::Expression*>& arguments) const noexcept {
    // prepare the dispatch handler now
...
Talos::Bytecode::Register::List Talos::Bytecode::Invoker::m_prepare(Compiler* compiler, Destination& destination,
...
void Talos::Bytecode::Invoker::m_invoke(Compiler* compiler, Destination destination) const noexcept {
    switch (m_convention) {
...
void Talos::Bytecode::Invoker::m_spawn(Compiler* compiler, Destination destination) const noexcept {
    switch (m_convention) {
