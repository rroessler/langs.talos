#ifndef _TALOS_LEXER_GENERATOR_HPP
#define _TALOS_LEXER_GENERATOR_HPP
...
#define TALOS_XX_TOKEN_SYMBOL(_, S, ...) dt[S[0]] = Dispatch::m_symbol<S[0]>;
#include "talos/lexer/_defines/tokens.def"  // define all the necessary dispatchers
