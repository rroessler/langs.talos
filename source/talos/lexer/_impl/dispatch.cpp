...
/// Lexer Includes
#include "talos/lexer/_inline/generator.ipp"

//  PUBLIC METHODS  //

void Talos::Lexer::Dispatch::next(Scanner &lexer, Buffer &buffer) {
  ...
  static constexpr auto s_table = Talos::Lexer::Generator::table();
  $_MUSTTAIL return s_table[static_cast<uint8_t>(head)](lexer, buffer);
}

//  PRIVATE METHODS  //

$::String::Buffer Talos::Lexer::Dispatch::m_escape(int64_t cp) {
...
void Talos::Lexer::Dispatch::m_invalid(Scanner &lexer, Buffer &tokens) {
