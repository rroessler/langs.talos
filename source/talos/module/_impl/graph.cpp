...
std::vector<Talos::Module::Interface*> Talos::Import::Graph::roots() const noexcept {
    auto predicate = [](const Nodule* node) { return node->module; };
    return $::Ranges::To(m_roots | std::views::transform(predicate));
}

std::vector<Talos::Module::Interface*> Talos::Import::Graph::leaves() const noexcept {
...
Talos::Import::Nodule* Talos::Import::Graph::m_link(Module::Interface* module, Nodule* parent) {
...
std::future<Talos::Module::Interface*> Talos::Import::Graph::m_import(const $::URI::View& resource) const {
...
std::vector<Talos::Module::Interface*> Talos::Import::Graph::m_import(const Dependencies& resources) const {
...
std::vector<Talos::Module::Interface*> Talos::Import::Graph::m_import(Talos::Module::Interface* parent) const {
