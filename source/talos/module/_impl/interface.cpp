...
void Talos::Module::Interface::parse(XI::Container* services) {
...
void Talos::Module::Interface::analyze(XI::Container* services) {
...
Talos::Linker::Arena* Talos::Module::Interface::compile(XI::Container* services) {
...
Talos::Async::Thenable* Talos::Module::Interface::interpret(Runtime::Isolate* isolate, const Resource::Trace& trace) {
...
Talos::Syntax::Dependencies Talos::Module::Interface::m_dependencies() const noexcept {
    return metadata<Phase::PARSED>()->tree()->dependencies();
}

$::Ptr::Shared<Talos::Document::Buffer> Talos::Module::Interface::m_document(XI::Container* services) const noexcept {
...
void Talos::Module::Interface::m_parse(XI::Container* services, Metadata::Attributes<Phase::PARSED>* syntax) {
...
void Talos::Module::Interface::m_analyze(XI::Container* services, Metadata::Attributes<Phase::TYPED>* types) {
...
void Talos::Module::Interface::m_compile(XI::Container* services, Metadata::Attributes<Phase::COMPILED>* codegen) {
...
Talos::Async::Thenable* Talos::Module::Interface::m_interpret(
