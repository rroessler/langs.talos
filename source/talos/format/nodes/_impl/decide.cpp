...
size_t Talos::Format::Node::Decide::m_width(const Wrap::List& wrapped, bool force) const noexcept {
...
void Talos::Format::Node::Decide::m_render(Writer* writer, Wrap wrapping) const noexcept {
