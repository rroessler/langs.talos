...
size_t Talos::Format::Piece::Line::m_width(const Wrap::List &, bool) const noexcept {
  switch (m_state) {
...
void Talos::Format::Piece::Line::m_render(Writer *writer, Wrap wrapping) const noexcept {
