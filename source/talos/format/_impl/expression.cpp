...
Talos::Format::Node* Talos::Format::Dispatch::m_expression(Reader* reader, Precedence rank) {
    return Syntax::Generator::expression<Node, Reader, Dispatch>(reader, rank);
}

Talos::Format::Node* Talos::Format::Dispatch::m_assignment(Reader* reader, Node* target) {
    return m_assignment(reader, target, [](Reader* reader) { return m_expression(reader); });
}

Talos::Format::Node* Talos::Format::Dispatch::m_assignment(Reader* reader, Node* target, Callback&& callback) {
