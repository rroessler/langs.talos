...
Talos::Globals::Callback Talos::Garbage::Service::m_forward() {
...
void Talos::Garbage::Service::m_recycle(Heap::Region* region, $::Set<Heap::Region*>& cache) {
    m_recycle(region), cache.erase(region);
}

void Talos::Garbage::Service::m_recycle(const $::Set<Heap::Region*>& regions, $::Set<Heap::Region*>& cache) {
