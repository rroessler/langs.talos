...
void Talos::Garbage::Marker::mark(Mode mode, Globals::Roots *roots) {
...
bool Talos::Garbage::Marker::m_blacken(Object::Header *header, Globals::Each &yield) {
...
Talos::Heap::Region *
Talos::Garbage::Marker::m_target(Mode mode, size_t size, size_t survivors, Heap::Epoch epoch) const noexcept {
  switch (epoch) {
