...
$_NORETURN void Talos::Testing::Main::m_execute() {
...
bool Talos::Testing::Main::m_analyze(const $::URI::Buffer& resource, Diagnostic::Reporter* reporter) {
...
void Talos::Testing::Main::m_empty() {
    if (m_spinner) m_spinner->dismiss(), m_spinner = nullptr;
    $::IO::cout() << $::Dye::yellow("No tests found!") << '\n';
}

bool Talos::Testing::Main::m_report(Diagnostic::Reporter* reporter, size_t sources) {
...
void Talos::Testing::Main::m_unhandled($::Map<$::URI::View, Value::Any>&& errors) {
...
void Talos::Testing::Main::m_unhandled(const $::URI::View& resource, Value::Any reason) {
...
Talos::Async::Thenable* Talos::Testing::Main::m_import(const $::URI::Buffer& resource, Diagnostic::Reporter* reporter) {
