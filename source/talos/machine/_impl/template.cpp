...
Talos::Machine::Reference Talos::Machine::Dispatch::lor(Reference left, Reference right) {
    return Value::Boolean(Value::Any(left).truthiness() || Value::Any(right).truthiness());
}

Talos::Machine::Reference Talos::Machine::Dispatch::land(Reference left, Reference right) {
    return Value::Boolean(Value::Any(left).truthiness() && Value::Any(right).truthiness());
}

Talos::Machine::Reference Talos::Machine::Dispatch::recall(
...
Talos::Machine::Reference Talos::Machine::Dispatch::invoke(
...
Talos::Machine::Reference Talos::Machine::Dispatch::spawn(
...
void Talos::Machine::Template::negate(Builder *builder, Bytecode::Instruction *instruction) {
...
void Talos::Machine::Template::unary(Builder *builder, Operator::Kind kind, Bytecode::Instruction *instruction) {
...
void Talos::Machine::Template::coalesce(Builder *builder, Bytecode::Instruction *instruction) {
    // get the underlying qualified instruction to be used
...
void Talos::Machine::Template::logical(Builder *builder, Operator::Kind kind, Bytecode::Instruction *instruction) {
    // get the underlying qualified instruction to be used
    auto *qualified = static_cast<Bytecode::Qualified<Bytecode::Syllable::BINOP_TPL> *>(instruction);
...
void Talos::Machine::Template::equality(Builder *builder, Operator::Kind kind, Bytecode::Instruction *instruction) {
    // get the underlying qualified instruction to be used
    auto *qualified = static_cast<Bytecode::Qualified<Bytecode::Syllable::BINOP_TPL> *>(instruction);
...
void Talos::Machine::Template::binary(Builder *builder, Operator::Kind kind, Bytecode::Instruction *instruction) {
    Binary::slow(builder, kind, instruction);
}

void Talos::Machine::Template::binary_i(Builder *builder, Operator::Kind kind, Bytecode::Instruction *instruction) {
    Binary::fast(builder, kind, instruction);
}

void Talos::Machine::Template::compare(Builder *builder, Operator::Kind kind, Bytecode::Instruction *instruction) {
    Compare::slow(builder, kind, instruction);
}

void Talos::Machine::Template::compare_i(Builder *builder, Operator::Kind kind, Bytecode::Instruction *instruction) {
    Compare::fast(builder, kind, instruction);
}

Talos::Machine::Register Talos::Machine::Template::getter(
...
void Talos::Machine::Template::getter(
...
void Talos::Machine::Template::recall(
    Builder *builder, const Engine::Register &dv, const Engine::Register::Span &span) {
    recall(builder, __ee__ resolve(dv), span);
}

void Talos::Machine::Template::recall(Builder *builder, const Register &dx, const Engine::Register::Span &span) {
...
void Talos::Machine::Template::invoke(
...
void Talos::Machine::Template::invoke(Builder *builder, const Engine::Register &dv, const Engine::Register &tv,
...
void Talos::Machine::Template::invoke(Builder *builder, const Engine::Register &dv, const Register &tx,
    const Engine::Register &self, const Engine::Register::Span &span) {
...
void Talos::Machine::Template::spawn(
    Builder *builder, const Engine::Register &dv, const Engine::Register &tv, const Engine::Register::Span &span) {
    spawn(builder, dv, tv, {}, span);
}

void Talos::Machine::Template::spawn(Builder *builder, const Engine::Register &dv, const Engine::Register &tv,
    const Engine::Register &self, const Engine::Register::Span &span) {
...
void Talos::Machine::Template::spawn(Builder *builder, const Engine::Register &dv, const Register &tx,
    const Engine::Register &self, const Engine::Register::Span &span) {
    // prepare a necessary registers to be used
    auto dx = __ee__ resolve(dv);
