...
$_INLINE_FORCE Talos::Value::Any Talos::Engine::Dispatch::m_list(
    Isolate* isolate, const std::span<Value::Any>& values) {
    return isolate->create<Iterable::List>(values);
}

$_INLINE_FORCE Talos::Value::Any Talos::Engine::Dispatch::m_iterator(Isolate* isolate, Value::Any iterable) {
...
TALOS_MM_ENGINE_EXECUTE(ITER_NEXT, isolate, frame, instruction) {
