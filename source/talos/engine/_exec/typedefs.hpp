...
$_INLINE_FORCE Talos::Value::Any Talos::Engine::Dispatch::m_ensure(
...
$_INLINE_FORCE Talos::Engine::Subtype Talos::Engine::Dispatch::m_extends(Value::Any value, Value::Any guard) {
...
TALOS_MM_ENGINE_EXECUTE(TYPE_CAST, isolate, frame, instruction) {
...
TALOS_MM_ENGINE_EXECUTE(TYPE_GUARD, , frame, instruction) {
