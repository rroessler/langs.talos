...
namespace Shell::Task {
    ...
    class Branch : public $::Printable {
       ...
       public:
         ...
         */
        $::Dict<$::String::Buffer> tasks(const Talos::Crate::Manifest* crate) const;
       ...
       protected:
         ...
         * @param crate                 Crate workspace.
         */
        XPC::Core::Child m_spawn($::String::Buffer script, const Talos::Crate::Manifest* crate) const;
         ...
         */
        static void m_print($::Stream::Output& os, const Branch& self);
    };
