...
To coincide with the previous release of [compile-time attributes](/language/fundamentals/attributes), Talos now provides support for decorators, which annotate variable declarations at runtime.
...
- Added: Foundations for [builtin language features](/builtins), documenting their use cases, types and fields. These currently contain stub pages so will be further updated with the progression of Talos.
