...
title: Welcome
icon: Sword
description: A quick insight to the Talos programming language
---

import { Portal } from '@/website/components';

This is the official documentation for the Talos programming language &nbsp;&mdash;&nbsp; a statically typed, dynamic programming language that aims to improve development workflow through extension builtin tooling.
...
<div className="mt-8 grid grid-cols-1 gap-4 text-start md:grid-cols-2 w-full">
    ...
    <Portal name="Install" icon="download" href="/docs/language/development/installation" description="Download Talos to get started." />
    <Portal name="Tutorial" icon="rocket" href="/docs/language/development/quick-start" description="A beginners introduction to Talos." />
    <Portal name="Syntax" icon="whole-word" href="/docs/language/fundamentals/syntax" description="Get familiar with the fundamental syntax of Talos." />
    <Portal name="Toolkit" icon="toolbox" href="/docs/language/toolkit/commands" description="An overview of the toolkit commands shipped with Talos." />
