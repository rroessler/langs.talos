...
<div className="mt-8 grid grid-cols-1 gap-4 text-start md:grid-cols-2 w-full">
    ...
    <Portal name="Install" icon="download" href="/language/development/installation" description="Download Talos to get started." />
    <Portal name="Tutorial" icon="rocket" href="/language/development/quick-start" description="A beginners introduction to Talos." />
    <Portal name="Syntax" icon="whole-word" href="/language/fundamentals/syntax" description="Get familiar with the fundamental syntax of Talos." />
    <Portal name="Toolkit" icon="toolbox" href="/language/toolkit/commands" description="An overview of the toolkit commands shipped with Talos." />
