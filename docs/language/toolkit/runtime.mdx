...
icon: Play
title: Runtime
description: Executes Talos files and crates
---
...
Enables additional linting diagnostics. If any linting errors occur during the analysis phase, these will cause an immediate failure. Alternatively, the [`talos lint`](/docs/language/toolkit/linting) subcommand can be used.
