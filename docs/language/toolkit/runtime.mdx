...
Enables additional linting diagnostics. If any linting errors occur during the analysis phase, these will cause an immediate failure. Alternatively, the [`talos lint`](/language/toolkit/linting) subcommand can be used.
