...
By declaring a class that implements the `Disposable` interface, and attaching a disposal callback through the use of a [compile-time attribute](/docs/language/fundamentals/attributes), allows us to now have access to the `use` declaration.
