...
# Allows enabling "ccache" for projects.
macro(mono_ccache_setup)
    ...
    if(MONO_CCACHE_PROGRAM)
        ...
        cmake_policy(SET CMP0141 NEW) # required for use with "MSVC"
    else()
        mono_message_warn("Could not enable 'ccache': could not find program")
    endif()
endmacro()
